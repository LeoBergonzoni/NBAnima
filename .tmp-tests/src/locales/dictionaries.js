...
exports.getDictionary = exports.dictionaries = void 0;
const it = {
    common: {
        play: 'Gioca',
    ...
    home: {
        ...
        heroSubtitle: 'Sfida i tuoi amici, accumula Anima Points e colleziona carte epiche dedicate ai tuoi idoli NBA.',
        bullets: [
        ...
        onboarding: [
            {
                ...
                description: 'Studia il calendario, scegli la vincente e vivi la corsa alla gloria con NBAnima.',
            },
            {
                title: 'Scegli i tuoi giocatori Top',
                description: 'Punta sulle stelle che domineranno punti, assist e rimbalzi per moltiplicare i tuoi Anima Points.',
            },
            {
                title: 'Guadagna Anima Points e colleziona Card leggendarie',
                description: 'Completa le sfide, accumula punti e riscatta carte digitali uniche dedicate ai tuoi idoli.',
            },
            {
                title: 'Scala la classifica e dimostra la tua anima NBA',
                description: 'Condividi le vittorie con gli amici e diventa la leggenda indiscussa delle notti NBA.',
            },
        ],
        ...
        howToPlay: {
            ...
            play: {
                label: 'Play',
                description: 'Ogni giorno devi provare a indovinare squadre vincenti e giocatori migliori per accumulare Anima Points e acquistare esclusive Cards.',
                imageAlt: 'Esempio Anima Point',
                imageSrc: '/anima-point.png',
                teams: {
                    title: 'Categoria “Teams”',
                    description: 'In base alla giornata devi indovinare chi vincerà gli scontri diretti che si giocheranno la notte successiva.',
                ...
                highlights: {
                    ...
                    description: 'Indovina da 1 a 5 giocatori che entreranno nelle NBA Top 5 o Top 10 plays of the night.',
                ...
                multipliers: {
                    ...
                    description: 'Se indovini 5 risultati il totale ottenuto si moltiplica x2; con 10 risultati il totale si moltiplica x3.',
                },
                tileGame: {
    ...
    dashboard: {
        ...
        weeklyXpExplainer: 'I Weekly XP rispecchiano solo i punti da settlement, coprono la settimana Lun–Dom (ET) e si azzerano quando chiude il timer della prima partita della domenica.',
    ...
    play: {
        ...
        subtitle: 'Completa le sfide per ottenere il check verde e massimizzare i tuoi Anima Points.',
        multiplierHint: 'Se indovini 5 risultati in una notte il punteggio si moltiplica x2; con 10 risultati corretti si moltiplica x3.',
        links: {
            nbaStats: 'NBA Stats',
        ...
        players: {
            title: 'Players',
            description: 'Seleziona i protagonisti per punti, assist e rimbalzi. 50 Anima Points ogni scelta azzeccata.',
        ...
        changesHint: 'Modifiche effettuate oggi: {count}. Puoi aggiornare le tue picks tutte le volte che vuoi fino all’inizio delle partite.',
        lockCountdown: {
    ...
    tileGame: {
        ...
        sectionDescription: 'Completa lo schema in 15 mosse o meno per ottenere 10 Anima Points extra.',
    ...
    packs: {
        title: 'Bustine',
        description: 'Apri le bustine NBAnima per ottenere 4 cards casuali seguendo le probabilità indicate.',
        ...
        confirmMessage: 'Confermi di spendere {price} Anima Points per aprire la {pack}? Troverai 4 cards casuali.',
        confirmAdminMessage: 'Confermi di aprire gratuitamente la {pack} come Admin? Troverai 4 cards casuali.',
    ...
    user: {
        ...
        avatarModalSubtitle: 'Seleziona una delle immagini East o West Coast come avatar del tuo profilo.',
    ...
    auth: {
        ...
        signup: {
            ...
            switchCta: 'Accedi',
            confirmationNotice: 'Controlla la tua email per il link di conferma, aprilo e poi accedi con i dati appena inseriti.',
        },
        fields: {
...
const en = {
    ...
    home: {
        ...
        heroSubtitle: 'Challenge friends, earn Anima Points, and collect epic cards inspired by NBA legends.',
        bullets: [
        ...
        onboarding: [
            {
                ...
                description: 'Study the slate, pick the winners, and chase nightly glory with NBAnima.',
            },
            {
                title: 'Draft your Top performers',
                description: 'Lock in the stars who will lead the box score in points, assists, and rebounds.',
            },
            {
                title: 'Earn Anima Points and collect legendary cards',
                description: 'Redeem exclusive digital cards to power up your roster and show off your fandom.',
            },
            {
                title: 'Climb the leaderboard and prove your NBA spirit',
                description: 'Share your victories, challenge friends, and become the legend of NBA nights.',
            },
        ],
        ctaRegister: 'Sign up',
        ctaLogin: 'Log in',
        howToPlay: {
            ...
            play: {
                label: 'Play',
                description: 'Every day, predict the winning teams and standout players to earn Anima Points and unlock exclusive Cards.',
                imageAlt: 'Example of Anima Point',
                imageSrc: '/anima-point.png',
                teams: {
                    title: '“Teams” category',
                    description: 'Look at the nightly schedule and pick which team will win each head-to-head matchup.',
                ...
                highlights: {
                    ...
                    description: 'Select 1 to 5 players you expect to feature in the NBA Top 5 or Top 10 plays of the night.',
                ...
                multipliers: {
                    ...
                    description: 'Hit 5 correct results to double (x2) your total, or 10 correct results to triple (x3) it.',
                },
                tileGame: {
                    title: 'Tile Flip Game',
    ...
    dashboard: {
        ...
        weeklyXpExplainer: 'Weekly XP mirror settlement-only points, cover the Mon–Sun (ET) week, and reset when the Sunday pick window closes (first game starts).',
    ...
    play: {
        ...
        subtitle: 'Complete the challenges to secure the green check and maximize your Anima Points.',
        multiplierHint: 'Hit 5 correct picks in a night to double (x2) your total – nail 10 and it triples (x3).',
        links: {
            nbaStats: 'NBA Stats',
            nbaLineups: 'NBA Starting lineups',
        },
        ...
        players: {
            title: 'Players',
            description: 'Select the standout performers for points, assists, and rebounds. 50 Anima Points for each correct choice.',
            endPicks: 'End picks',
        ...
        submit: 'Save picks',
        update: 'Update picks',
        changesHint: 'Changes made today: {count}. You can keep updating your picks freely until tip-off.',
        lockCountdown: {
    ...
    tileGame: {
        sectionTitle: 'Tile Flip Game',
        sectionDescription: 'Beat the board in 15 moves or less to collect 10 bonus Anima Points.',
    ...
    shop: {
        ...
        confirmMessage: 'Are you sure you want to purchase this Card for {price} Anima Points?',
        owned: 'Purchased',
        errorGeneric: 'Something went wrong. Please try again.',
    },
    packs: {
        title: 'Card Packs',
        description: 'Crack open NBAnima packs to reveal 4 random cards following the listed odds.',
        oddsTitle: 'Odds',
        firstCommon: '4 random cards inside.',
        openCta: 'Open pack',
        adminCta: 'Buy as Admin',
        confirmTitle: 'Open this pack?',
        confirmMessage: 'Spend {price} Anima Points to open the {pack}? You will receive 4 random cards.',
        confirmAdminMessage: 'Open the {pack} for free as Admin? You will receive 4 random cards.',
    ...
    user: {
        ...
        avatarModalSubtitle: 'Pick one of the East or West Coast tiles to use as your profile image.',
        eastLabel: 'East Coast',
        westLabel: 'West Coast',
        nicknameLabel: 'Nickname',
    ...
    auth: {
        ...
        signup: {
            ...
            switchCta: 'Log in',
            confirmationNotice: 'Check your inbox for the confirmation link, click it, then sign in with the credentials you just created.',
        },
        fields: {
...
const getDictionary = async (locale) => exports.dictionaries[locale] ?? exports.dictionaries.it;
